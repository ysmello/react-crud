...
const EnhancedTableToolbar = props => {
  ...
  const { selected, handleChangeModal, handleDelete } = props;
      ...
      {numSelected === 1 ? (
        <>
          <Tooltip title='Editar'>
            <IconButton aria-label='edit' onClick={handleChangeModal}>
              <EditIcon />
            </IconButton>
          </Tooltip>
...
function EnhancedTable({
  ...
  const confirmAndClearState = product => {
    !selected[0] ? postProduct(product) : putProduct(product);
    setSelected([]);
  };
  ...
  return (
    <div>
      <FormDialog
        ...
        onConfirm={confirmAndClearState}
      />
